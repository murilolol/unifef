/* ==============================================================================
   ...
   TEMA:       Material 04 - Estrutura do Banco de Dados e Carga Completa (DDL/DML)
   ==============================================================================
   COMO EXECUTAR:
   1. Conecte-se ao seu SGBD de preferência (PostgreSQL, MySQL, MariaDB, SQLite ou SQL Server).
   2. Execute este script integralmente para recriar as tabelas e povoar a base de dados.
   3. Este script é estritamente idempotente (remove tabelas prévias antes de recriá-las).
   ============================================================================== */

-- -----------------------------------------------------------------------------
-- 1. LIMPEZA PREVENTIVA DE ESTRUTURAS ANTERIORES (DDL)
-- -----------------------------------------------------------------------------
...
-- -----------------------------------------------------------------------------
-- 3. CARGA DE DADOS - TABELA CLIENTE (50 REGISTROS)
-- -----------------------------------------------------------------------------
...
-- -----------------------------------------------------------------------------
-- 4. CARGA DE DADOS - TABELA PRODUTO (50 REGISTROS)
-- -----------------------------------------------------------------------------
...
-- -----------------------------------------------------------------------------
-- 5. CARGA DE DADOS - TABELA VENDEDOR (50 REGISTROS)
-- -----------------------------------------------------------------------------
...
-- -----------------------------------------------------------------------------
-- 6. CARGA DE DADOS - TABELA PEDIDO (50 REGISTROS)
-- -----------------------------------------------------------------------------
